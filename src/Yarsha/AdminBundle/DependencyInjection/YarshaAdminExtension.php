...
namespace Yarsha\AdminBundle\DependencyInjection;
 ...
 */
class YarshaAdminExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
        ...
        */
        ...
        $factory->create('yarsha_admin', array(
            array(
                ...
                'path' => '^/admin', // path-regex, must match the firewall pattern
                'host' => null,
                'request_matcher' => null,

                // When not set this will inherit from the user-system name provided above
                'services_prefix' => 'yarsha_admin',
                'routes_prefix' => 'yarsha_admin',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'Yarsha\AdminBundle\Entity\User',
                'firewall_name' => 'admin', // this must equal to the firewall-name used for this user-system
                ...
                'security' => array(
                    'login' => array(
                        'template' => 'YarshaAdminBundle:UserBundle/Security:login.html.twig',
                    ),
                ),
                ...
                /*
                'group' => array(
                    'group_class' => 'Yarsha\AdminBundle\Entity\Group',
