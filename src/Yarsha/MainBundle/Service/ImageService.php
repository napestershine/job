 ...
 * @DI\Service("yarsha.service.image_cropper", parent="yarsha.service.abstract")
...
class ImageService extends AbstractService
{
    ...
    private function setFile($file)
    {
        ...
        if ($errorCode === UPLOAD_ERR_OK) {
            ...
            if ($type) {
                ...
                $src = 'uploads/seekers/' . $this->filename . $extension;
    ...
    {
        $this->dst = 'uploads/seekers/' . $this->filename . $this->extension;
    }
