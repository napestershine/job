...
namespace Yarsha\AgencyBundle\DependencyInjection;
 ...
 */
class YarshaAgencyExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'yarsha_agency_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('yarsha_agency', array(
            array(
                /*
                ...
                'path' => '^/agency', // path-regex, must match the firewall pattern
                'host' => null,
                'request_matcher' => null,

                // When not set this will inherit from the user-system name provided above
                'services_prefix' => 'yarsha_agency',
                'routes_prefix' => 'yarsha_agency',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'Yarsha\AgencyBundle\Entity\User',
                'firewall_name' => 'agency', // this must equal to the firewall-name used for this user-system
                ...
                'security' => array(
                    'login' => array(
                        'template' => 'YarshaAgencyBundle:UserBundle/Security:login.html.twig',
                    ),
                ),
                ...
                /*
                'group' => array(
                    'group_class' => 'Yarsha\AgencyBundle\Entity\Group',
