 ...
 * @DI\Service("yarsha.block.seeker_profile")
 * @DI\Tag("sonata.block")
 */
class ProfileBlockService extends AbstractAdminBlockService
{
    ...
    {
        parent::__construct("yarsha.block.seeker_profile" ,$templating);
        $this->em = $em;
    ...
    public function configureSettings(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'title' => null,
            'template' => '@YarshaJobSeeker/Blocks/Profile/education_information.html.twig',
            'section' => 'education',
            'seeker' => null,
            'employer' => false
        ]);
