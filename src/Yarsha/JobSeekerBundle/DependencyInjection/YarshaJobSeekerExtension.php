 ...
 */
class YarshaJobSeekerExtension extends Extension
{
    /**
     * {@inheritdoc}
     */
    public function load(array $configs, ContainerBuilder $container)
    {
        ...
        /*
            ...
            Will internally get converted to an 'yarsha_job_seeker_profile' form-type service definition.
            Never set the template namespace to FOSUserBundle or RollerworksMultiUserBundle as this will create an endless recursion!
        */

        $factory->create('yarsha_job_seeker', array(
            array(
                /*
                ...
                'services_prefix' => 'yarsha_job_seeker',
                'routes_prefix' => 'yarsha_job_seeker',

                'db_driver' => 'orm', // can be either: orm, mongodb, couchdb or custom (Propel is not supported)
                'model_manager_name' => 'default',
                'use_listener' => true,

                'user_class' => 'Yarsha\JobSeekerBundle\Entity\User',
                'firewall_name' => 'seeker', // this must equal to the firewall-name used for this user-system
                ...
                'security' => array(
                    'login' => array(
                        'template' => 'YarshaJobSeekerBundle:UserBundle/Security:login.html.twig',
                    ),
                ),
                ...
                /*
                'group' => array(
                    'group_class' => 'Yarsha\JobSeekerBundle\Entity\Group',
