 ...
 */
class Version20170127071338 extends AbstractMigration
{
...
//        $this->addSql('ALTER TABLE ys_job_seeker_experiences ADD CONSTRAINT FK_B2B604E389E04D0 FOREIGN KEY (organization_type_id) REFERENCES ys_organization_types (id)');
        $this->addSql('ALTER TABLE ys_job_seeker_settings DROP INDEX IDX_5AA160B8C2C5BAA3, ADD UNIQUE INDEX UNIQ_5AA160B8C2C5BAA3 (job_seeker_id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE ys_job_seeker_settings DROP INDEX UNIQ_5AA160B8C2C5BAA3, ADD INDEX IDX_5AA160B8C2C5BAA3 (job_seeker_id)');
    }
}
